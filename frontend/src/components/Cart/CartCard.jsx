...
const CartCard = ({
	...
	return (
		<div className="flex hover:scale-105 transition-all duration-200 shadow-nice gap-3 items-center bg-white p-3 rounded-lg">
			...
			<div className="space-y-2 w-[70%]">
				...
				<p className="text-base capitalize overflow-hidden h-[3rem] font-semibold">
					{food.description}
				</p>
			...
			<div>
				{spinningDelete === food._id ? (
					...
					<button
						className="flex justify-center active:translate-y-1 transition-all items-center gap-2 w-28 h-12 cursor-pointer rounded-md shadow-2xl text-white font-semibold bg-gradient-to-r from-orange-500  to-orange-800 hover:shadow-xl hover:shadow-red-500 hover:scale-105 duration-300 hover:from-[#be123c] hover:to-[#fb7185]"
						onClick={() =>
							deleteHandler(
								restaurant_name,
								category,
